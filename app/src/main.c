...
/* IOTEMBSYS: Add required import shell and/or others, is using */
...
/* IOTEMBSYS: Create synchronization to unblock the sender task */

/* IOTEMBSYS: Create synchronization to pass the socket to the receiver task */
...
static void button_pressed(const struct device *dev, struct gpio_callback *cb,
	...
	/* IOTEMBSYS: Tell the TCP thread to start doing work (if using buttons instead of shell). */
...
/* IOTEMBSYS: Create and define the TCP sender thread */

/* IOTEMBSYS: Create and define the TCP receiver thread */
...
/* IOTEMBSYS: Add shell commands and handler, if using shell instead of button. */
